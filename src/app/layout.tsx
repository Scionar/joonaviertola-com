...
export const metadata: Metadata = {
  ...
  description: `Excellent home page of IT consultant working with web development`,
};
        ...
        <footer>
          ...
          <ul className="social-media">
            <li>
              <a
                aria-label="LinkedIn"
                href="https://www.linkedin.com/in/joonaviertola"
                target="_blank"
